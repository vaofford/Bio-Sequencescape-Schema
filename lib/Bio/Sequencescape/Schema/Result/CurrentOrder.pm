use utf8;
package Bio::Sequencescape::Schema::Result::CurrentOrder;
...
Bio::Sequencescape::Schema::Result::CurrentOrder
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JyTwa3U+HyGHWyhIQJ2XlA
