use utf8;
package Bio::Sequencescape::Schema::Result::CurrentAssetAudit;
...
Bio::Sequencescape::Schema::Result::CurrentAssetAudit
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bvCyS2vS2HCP92MuH+OSUg
