use utf8;
package Bio::Sequencescape::Schema::Result::CurrentBatch;
...
Bio::Sequencescape::Schema::Result::CurrentBatch
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8RYe/bwqk1+XxBYNohZRuA
