use utf8;
package Bio::Sequencescape::Schema::Result::SampleTube;
...
Bio::Sequencescape::Schema::Result::SampleTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yZi2iKevAcyNQm87AkNBVA
