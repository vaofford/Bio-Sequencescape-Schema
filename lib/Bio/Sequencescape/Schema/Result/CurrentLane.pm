use utf8;
package Bio::Sequencescape::Schema::Result::CurrentLane;
...
Bio::Sequencescape::Schema::Result::CurrentLane
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Hu4rnKOo7WzVZt0ekeZiNg
