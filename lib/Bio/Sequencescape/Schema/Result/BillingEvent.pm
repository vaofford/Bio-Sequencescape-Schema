use utf8;
package Bio::Sequencescape::Schema::Result::BillingEvent;
...
Bio::Sequencescape::Schema::Result::BillingEvent
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:csM2+XHSg4bpabSRrkqHBA
