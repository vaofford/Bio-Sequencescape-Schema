use utf8;
package Bio::Sequencescape::Schema::Result::CurrentSampleTube;
...
Bio::Sequencescape::Schema::Result::CurrentSampleTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1swCltZS4EK98AGCNirLuQ
