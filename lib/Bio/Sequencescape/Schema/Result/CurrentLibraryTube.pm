use utf8;
package Bio::Sequencescape::Schema::Result::CurrentLibraryTube;
...
Bio::Sequencescape::Schema::Result::CurrentLibraryTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3MFd1zYtL2Nm9Ixev35F9w
