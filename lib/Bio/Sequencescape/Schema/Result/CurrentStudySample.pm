use utf8;
package Bio::Sequencescape::Schema::Result::CurrentStudySample;
...
Bio::Sequencescape::Schema::Result::CurrentStudySample
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VKzZ72B7T87ufua9zu3XuQ
