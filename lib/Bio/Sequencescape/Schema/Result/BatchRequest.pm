use utf8;
package Bio::Sequencescape::Schema::Result::BatchRequest;
...
Bio::Sequencescape::Schema::Result::BatchRequest
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jclPElHI+bjN/ZVRr7xv9w
