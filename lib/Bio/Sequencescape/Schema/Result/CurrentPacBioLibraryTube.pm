use utf8;
package Bio::Sequencescape::Schema::Result::CurrentPacBioLibraryTube;
...
Bio::Sequencescape::Schema::Result::CurrentPacBioLibraryTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6tmfchZ8XXoH5Kkg5s39lg
