use utf8;
package Bio::Sequencescape::Schema::Result::CurrentBillingEvent;
...
Bio::Sequencescape::Schema::Result::CurrentBillingEvent
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:z7xbBSebQGMNQXH6R32QGg
