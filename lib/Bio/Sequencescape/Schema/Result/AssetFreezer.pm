use utf8;
package Bio::Sequencescape::Schema::Result::AssetFreezer;
...
Bio::Sequencescape::Schema::Result::AssetFreezer
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZgvCT1DQTu+qGkON6ZBnEw
