use utf8;
package Bio::Sequencescape::Schema::Result::MultiplexedLibraryTube;
...
Bio::Sequencescape::Schema::Result::MultiplexedLibraryTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Dp/e13ASC2TLnKaeKbL+Tw
