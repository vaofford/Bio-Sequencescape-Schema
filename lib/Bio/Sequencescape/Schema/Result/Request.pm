use utf8;
package Bio::Sequencescape::Schema::Result::Request;
...
Bio::Sequencescape::Schema::Result::Request
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:41YdpLH+Vmwx6ylxRJOxmg
