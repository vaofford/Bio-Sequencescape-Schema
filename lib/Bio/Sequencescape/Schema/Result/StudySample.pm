use utf8;
package Bio::Sequencescape::Schema::Result::StudySample;
...
Bio::Sequencescape::Schema::Result::StudySample
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5PYY7BdrP1yaWTbIzaJrig
