use utf8;
package Bio::Sequencescape::Schema::Result::CurrentQuota;
...
Bio::Sequencescape::Schema::Result::CurrentQuota
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:J1lGc/3nStvc9pUKzYQa4g
